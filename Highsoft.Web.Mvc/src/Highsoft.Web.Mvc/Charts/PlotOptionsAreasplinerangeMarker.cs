// Type: Highsoft.Web.Mvc.Charts.PlotOptionsAreasplinerangeMarker
...
{
	public class PlotOptionsAreasplinerangeMarker : BaseObject
	{
		public PlotOptionsAreasplinerangeMarker()
		{
			...
			this.States = this.States_DefaultValue = new PlotOptionsLineMarkerStates();
